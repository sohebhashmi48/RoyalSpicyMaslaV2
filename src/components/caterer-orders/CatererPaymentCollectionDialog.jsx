...
export default function CatererPaymentCollectionDialog({
  ...
  console.log('CatererPaymentCollectionDialog props:', {
    isOpen,
  ...
  if (isOpen) {
    console.log('💰 Payment dialog opened with:');
    console.log('  - Caterer:', caterer);
    console.log('  - Bill:', bill);
    console.log('  - Bill pending amount:', bill?.pending_amount);
  }
  ...
  // Reset form when dialog opens/closes - FIXED
  useEffect(() => {
    if (isOpen && bill) {
